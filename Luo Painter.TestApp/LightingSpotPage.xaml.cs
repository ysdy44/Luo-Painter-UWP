...
{
    public sealed partial class LightingSpotPage : Page
    {
        ...
        SpotDiffuseEffect Diffuse;
        SpotSpecularEffect Specular;
        ...
        float Angle = 14 * MathF.PI / 180;

        float Ambient = 0;
        
        public LightingSpotPage()
        {
        ...
        public void ConstructLighting()
        {
            ...
            this.AngleSlider.ValueChanged += (s, e) =>
            {
                this.Angle = (float)e.NewValue * MathF.PI / 180;
                if (this.CanvasAnimatedControl.ReadyToDraw is false) return;

                this.Diffuse.LimitingConeAngle = this.Angle;
                this.Specular.LimitingConeAngle = this.Angle;
            };
        }
        ...
        private async Task CreateResourcesAsync(CanvasAnimatedControl sender)
        {
            ...
            this.Diffuse = new SpotDiffuseEffect
            {
                ...
                LightTarget = this.Target,
                LightPosition = this.Position + this.Target,
            };

            this.Specular = new SpotSpecularEffect
            {
                Source = this.HeightMap,
