...
{
    public sealed partial class DisplacementPushPage : Page
    {
        ...
        public DisplacementPushPage()
        {
            this.InitializeComponent();
            this.ConstructDisplacementPush();
            this.ConstructCanvas();
            this.ConstructOperator();
        }


        private void ConstructDisplacementPush()
        {
        ...
        {
            this.ShaderCodeBytes = await ShaderType.DisplacementPush.LoadAsync();
        }
