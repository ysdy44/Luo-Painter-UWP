...
{
    public sealed partial class InkStabilizerPage : Page
    {
        ...
        private void ConstructInkStabilizer()
        {
            ...
            {
                this.Stabilizer = (float)e.NewValue;
            };
            ...
            this.Timer.Elapsed += (s, e) =>
            {
                ...
                this.PositionStabilizer = this.StartingPosition + (vector / this.Stabilizer);
                using (CanvasDrawingSession ds = this.RenderTarget.CreateDrawingSession())
                {
